...
<div class="max-w-md mx-auto mt-20">
    <div class="glass p-10 rounded-3xl">
        <h2 class="text-3xl font-bold text-white mb-2">New Password</h2>
        <p class="text-gray-400 mb-8 text-sm">Please enter your new password below.</p>
        ...
        <form action="{{ route('password.update') }}" method="POST" class="space-y-6">
            ...
            <button type="submit" class="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-4 rounded-xl transition shadow-lg">
                Reset Password
            </button>
        </form>
    </div>
